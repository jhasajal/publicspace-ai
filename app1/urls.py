...
from . import views
from . import views
from .views import fire_detection_feed
from .views import mood_detection_view
...
urlpatterns = [
    ...
    path('fire-detection/', fire_detection_feed, name='fire_detection'),
    path('mood-detection/', mood_detection_view, name='mood_detection')
]
